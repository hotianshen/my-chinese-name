...
export const TIERS: Tier[] = [
  ...
  {
    id: 'L1', level: 1, name: 'Listener', zh: '闻音者', price: '$9.99', priceNum: 9.99,
  ...
  {
    id: 'L2', level: 2, name: 'Insighter', zh: '明义者', price: '$99.90', priceNum: 99.9,
  ...
  {
    id: 'L3', level: 3, name: 'Master', zh: '大师甄选', price: '$999', priceNum: 999,
  ...
  {
    id: 'L4', level: 4, name: 'Legacy', zh: '传承者', price: 'from $9,999', priceNum: 9999,
